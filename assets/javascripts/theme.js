	...
	var LockScreen = {
		...
		show: function() {
			...
			$.ajax({
		      ...
		      data: { "action": "setCookiePreventRefresh"},
		      dataType: "json"
		    }).done(function(data) {
		...
		hide: function() {
			...
			$.ajax({
		      method: "POST",
		      url: "/ajax/ajaxSession.php",
		      data: { "action": "unclockScreen", "passwordLockScreen": $("#passwordLockScreen").val()},
		      dataType: "json"
		    }).done(function(data) {
						...
						'<div class="center-sign">',
							'<div class="panel panel-sign">',
								'<div class="panel-body">',
									'<form method=post action="../../controllers/checkLoginController.php">',
										...
										'<div class="form-group mb-lg">',
											'<div class="input-group input-group-icon">',
												'<input id="passwordLockScreen" name="passwordLockScreen" type="password" class="form-control input-lg" placeholder="Password" />',
										...
										'<div class="row">',
											'<div class="col-xs-6">',
												'<p class="mt-xs mb-none">',
													'<a href="/controllers/logoutController.php">No ets tu?</a>',
												'</p>',
											'</div>',
