...
$modulActiu = 'cintesIHdd';

$arrayClients 	  	 = Client::loadClients();
$arrayHddsClients 	 = HddClient::loadHdds();
$arrayTipusUsuari 	 = TipusUsuari::loadTipusUsuaris();
$arrayIdiomes 	  	 = Idioma::loadIdiomas();
$arrayUsuarisClients = UsersClient::loadUserClients();
$arrayLocalitzacions = Localitzacio::loadLocalitzacions();
...
<html class="fixed">
	<head>
		...
		<title>Metropolitana Intrantet | Discs durs de clients</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					<!-- WIZARD INSERTAR NOU HDD -->
					<div class="row">
						<div class="col-xs-12">
							<section class="panel form-wizard panel-collapsed" id="w4">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Insertar nou disc dur</h2>
								</header>
								<div class="panel-body">
									<div class="wizard-progress wizard-progress-lg">
										...
										<ul class="wizard-steps">
											<li class="active">
												<a href="#w4-account" data-toggle="tab"><span>1</span>Client</a>
											</li>
											<li>
												<a href="#w4-profile" data-toggle="tab"><span>2</span>Info HDD</a>
											</li>
											<li>
												<a href="#w4-confirm" data-toggle="tab"><span>3</span>Localitzacio</a>
											</li>
										</ul>
									</div>
										...
										<div class="tab-content">
											<div id="w4-account" class="tab-pane active">
												<div class="form-group">
													...
													<div class="col-sm-6">
														<select id="selectClient" class="form-control" name="exp-month" required onchange="carregaAdrecaClient(this);">
												...
												<div class="form-group">
													<label class="col-sm-3 control-label" for="adrecaClient">Adreça</label>
													<div class="col-sm-6">
														<input type="text" class="form-control input-sm" id="adrecaClient" required readonly="">
													</div>
												</div>
											</div>
											<div id="w4-profile" class="tab-pane">
												<div class="form-group">
													<label class="col-sm-3 control-label" for="projecte">Projecte</label>
													<div class="col-sm-6">
														<input type="text" class="form-control input-sm" name="first-name" id="projecte" required>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label" for="descripcio">Ddescripció</label>
													<div class="col-sm-6">
														<textarea class="form-control input-sm" rows="3" id="descripcio" name="last-name" style="margin-top: 0px; margin-bottom: 0px; height: 111px;"></textarea>
													</div>
												</div>
											</div>
											...
											<div id="w4-confirm" class="tab-pane">
												<div class="form-group">
													<label class="col-sm-3 control-label" for="localitzacio">Localització</label>
													<div class="col-sm-6">
														...
														foreach($arrayLocalitzacions as $index => $infoLoalitzacio)
														{
															?>
															<option value="<?php echo $infoLoalitzacio -> getId(); ?>"><?php echo $infoLoalitzacio -> getLloc(); ?></option>
															<?php
														}
														?>
														</select>
								...
								<div class="panel-footer">
									<ul class="pager">
										...
										<li class="finish hidden pull-right">
											<a onclick="return insertClientHdd();">Insertar</a>
										</li>
										<li class="next">
									...
									<div id="taulaHdd" class="dataTables_wrapper no-footer">
										<div class="table-responsive">
											<table class="table table-bordered table-striped mb-none dataTable no-footer" id="datatable-default" role="grid" aria-describedby="datatable-default_info">
												<thead>
													<tr role="row">
														<th class="sorting_asc" tabindex="0" aria-controls="datatable-default" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 5%;">HDD Id
														</th>
														<th class="sorting" tabindex="0" aria-controls="datatable-default" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 30%;">Client / Adreça
														</th>
														<th class="hidden-xs sorting" tabindex="0" aria-controls="datatable-default" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 30%;">Projecte / Departament
														</th>
														<th class="hidden-xs sorting" tabindex="0" aria-controls="datatable-default" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 15%;">Localització</th>
														<th class="hidden-xs sorting" tabindex="0" aria-controls="datatable-default" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 10%;">Estat</th>
												...
												<tbody>
													<?php
													foreach($arrayHddsClients as $index => $infoHdd)
													{
														// Busquem el nom del client per no mostrar el id
														$hddClient  = new Client($infoHdd -> getClient());

														$rutaDelete = '/controllers/hddClientsController/deleteUserController.php?hddId='.$infoHdd -> getId();
														$estat = new TipusEstat($infoHdd -> getEstat());
														?>
														<tr role="row" class="odd">
															<td class="sorting_1" id="hddId"><?php echo $infoHdd -> getId(); ?></td>
															<td>
																<strong>Nom: </strong><?php echo $hddClient -> getNom(); ?>
																<br>
																<strong>Adreça: </strong><?php echo $hddClient -> getAdreca(); ?>
															</td>
															<td class="center hidden-xs"><?php echo $infoHdd -> getProjecteDepartament(); ?></td>
															<td class="center hidden-xs"><?php echo $infoHdd -> getLocalitzacio(); ?></td>
															...
															<td class="center hidden-xs">
																...
																<!-- EDITAR -->
																<a onclick='return loadHddModal("<?php echo $infoHdd-> getId(); ?>")'><i class="el el-edit"></i></a>
